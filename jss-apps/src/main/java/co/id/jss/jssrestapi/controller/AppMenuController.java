...
import co.id.jss.jssrestapi.service.MenuService;
...
public class AppMenuController extends RoleController {
    ...
    @Autowired
    public AppMenuController(MenuService menuService, VarExceptionEngine varExceptionEngine, AuthUtils authUtils) {
